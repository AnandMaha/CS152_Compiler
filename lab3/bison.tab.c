...
{
       0,   104,   104,   111,   114,   120,   119,   138,   141,   147,
     160,   164,   170,   178,   186,   194,   202,   211,   221,   229,
     234
};
#endif
...
#line 171 "bison.y" /* yacc.c:1646  */
  ...
  out << ". " << temp << endl;
  out << "+ " << temp << ", " << (yyvsp[-2].op_val) << ", " << (yyvsp[0].op_val) << endl;
  out << "= " << (yyvsp[-4].op_val) << ", " << temp << endl;
}
...
#line 212 "bison.y" /* yacc.c:1646  */
    {
  if(find(string((yyvsp[-2].op_val)))){
    printf("statement -> IDENT := symbol\n");
    out << "= " << (yyvsp[-2].op_val) << ", " << (yyvsp[0].op_val) << endl;
  } else{
